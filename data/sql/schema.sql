...
CREATE TABLE dreamfish_group (id BIGINT AUTO_INCREMENT, dreamfish_group_type_id BIGINT, location VARCHAR(255), interest VARCHAR(255), contact_id BIGINT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX contact_id_idx (contact_id), INDEX dreamfish_group_type_id_idx (dreamfish_group_type_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE person (id BIGINT AUTO_INCREMENT, name VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, mobile_phone VARCHAR(31), avatar_id BIGINT, url VARCHAR(255), city VARCHAR(63), postal_code VARCHAR(15), timezone VARCHAR(15), feedback TEXT, about_me TEXT, twitter VARCHAR(255), payment_method_id BIGINT, chat_setting TINYINT DEFAULT '1' NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE project (id BIGINT AUTO_INCREMENT, project_type_id BIGINT NOT NULL, description TEXT NOT NULL, stage_id BIGINT, wiki_page VARCHAR(255), contact_id BIGINT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX project_type_id_idx (project_type_id), INDEX stage_id_idx (stage_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE project ADD CONSTRAINT project_stage_id_stage_id FOREIGN KEY (stage_id) REFERENCES stage(id);
ALTER TABLE project ADD CONSTRAINT project_project_type_id_project_type_id FOREIGN KEY (project_type_id) REFERENCES project_type(id);
