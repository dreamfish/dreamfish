CREATE TABLE project (id BIGINT AUTO_INCREMENT, name VARCHAR(255) NOT NULL, user_name VARCHAR(255) NOT NULL, description TEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE project_request (id BIGINT AUTO_INCREMENT, project_id BIGINT NOT NULL, request VARCHAR(255), deadline DATE, INDEX project_id_idx (project_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE project_request ADD CONSTRAINT project_request_project_id_project_id FOREIGN KEY (project_id) REFERENCES project(id);
