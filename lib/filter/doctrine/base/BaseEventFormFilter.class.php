...
abstract class BaseEventFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'venue_type_id' => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'venue_url'     => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'venue_type_id' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'venue_url'     => new sfValidatorPass(array('required' => false)),
