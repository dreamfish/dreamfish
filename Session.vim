...
set shortmess=aoO
badd +1 apps/frontend/modules/project/actions/actions.class.php
...
silent! normal! zE
let s:l = 78 - ((15 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
78
normal! 03l
tabedit apps/frontend/modules/project/templates/showSuccess.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
argglobal
2argu
edit apps/frontend/modules/project/templates/showSuccess.php
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
normal! 0
lcd ~/dreamfish
tabedit ~/dreamfish/lib/model/doctrine/Project.class.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 0
lcd ~/dreamfish
tabedit ~/dreamfish/lib/form/doctrine/ProjectForm.class.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 68 - ((20 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
normal! 070l
lcd ~/dreamfish
tabedit ~/dreamfish/config/doctrine/schema.yml
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
set winheight=1 winwidth=1
argglobal
edit ~/dreamfish/config/doctrine/schema.yml
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
