 ...
 */ /**
 * sfRenderingFilter is the last filter registered for each filter 
chain. This
 ...
 * @version SVN: $Id$
 */ 
 class mediaWikiFilter extends sfFilter {
  /**
...
initialization
   * @throws <b>sfViewException</b> If an error occurs while executing 
the view
   */
  public function execute($filterChain)
  {
    ...
    {
      $this->getContext()->getLogger()->info('{sfFilter} render to 
client');
    }
    // get response object
...
sfConfig::get('sf_logging_enabled'))
    {
      ...
      {
        $logger->info(sprintf('{sfTimerManager} %s %.2f ms (%d)', $name, 
$timer->getElapsedTime() * 1000, $timer->getCalls()));
      }
    }
  }
}
